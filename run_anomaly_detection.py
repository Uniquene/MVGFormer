...
if __name__ == "__main__":
    ...
    data_info={
        'SWaT': {"root_path": "SWaT", "data": "SWAT", "seq_len": 100, "pred_len": 0, "d_model": 8,
                "enc_in": 51, "dec_in": 51, "c_out": 51, "batch_size": 128, "anomaly_ratio": 1, "train_epochs": 3,
                "self_loop": True},
        'MSL': {"root_path": "MSL", "data": "MSL", "seq_len": 100, "pred_len": 0, "d_model": 8,
                       "enc_in": 55, "dec_in": 55, "c_out": 55, "batch_size": 128, "anomaly_ratio": 1, "train_epochs": 6,
                       "self_loop": False},
        'SMD': {"root_path": "SMD", "data": "SMD", "seq_len": 100, "pred_len": 0, "d_model": 64,
                        "enc_in": 38, "dec_in": 38, "c_out": 38, "batch_size": 128, "anomaly_ratio": 0.5, "train_epochs": 15,
                        "self_loop": False},
               'SMAP': {"root_path": "SMAP", "data": "SMAP", "seq_len": 100, "pred_len": 0, "d_model": 128,
                       "enc_in": 25, "dec_in": 25, "c_out": 25, "batch_size": 128, "anomaly_ratio": 1, "train_epochs": 3,
                       "self_loop": False},
                'PSM': {"root_path": "PSM", "data": "PSM", "enc_in": 25, "dec_in": 25, "batch_size": 128, "c_out": 25,
                "d_model": 64, "seq_len": 100, "pred_len": 0, "anomaly_ratio": 1, "train_epochs": 3,
                "self_loop": False},
               }
    ...
    for data, info in data_info.items():
        ...
        parser.add_argument('--anomaly_ratio', type=float, default=info['anomaly_ratio'], help='prior anomaly ratio (%)(default:0.25)')
        ...
        setting = '{}_{}_{}_ft{}_sl{}_ll{}_pl{}_dm{}_loop1'.format(
            args.task_name,
            args.model,
            args.data,
            args.features,
        ...
        from nets.load_net_anomaly_detection import gnn_model
        ...
        from train.train_graph_anomaly_detection import train_epoch, evaluate_network
        ...
        try:
            with tqdm(range(params['epochs'])) as t:
                for epoch in t:
                    ...
                    epoch_test_loss = evaluate_network(args, model, device, train_loader, test_data, test_loader, epoch, setting)
                    ...
                    logger.info("training loss:{}".format(epoch_train_loss))
