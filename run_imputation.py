...
if __name__ == "__main__":
    ...
    data_info={
        ...
        'ETTm2': {"root_path": "ETT-small", "data_path": "ETTm2.csv", "data": "ETTm2_mask", "enc_in": 7, "dec_in": 7,
                  "c_out": 7, 'batch_size': 16, "d_model": 64, "seq_len": 96, "label_len": 0, 'pred_len': 0,
                  "train_epochs": 1, "learning_rate": 0.0005},   # epoch=10
        'ETTh1': {"root_path": "ETT-small", "data_path": "ETTh1.csv", "data": "ETTh1_mask", "enc_in": 7, "dec_in": 7,
                  "c_out": 7, "batch_size": 16, "d_model": 16, "seq_len": 96, "label_len": 0, 'pred_len': 0,
                  "train_epochs": 10, "learning_rate": 0.0005},
        'weather': {"root_path": "weather", "data_path": "weather.csv", "data": "custom_mask", "enc_in": 21,
                    "dec_in": 21, "c_out": 21, "batch_size": 16, "d_model": 64, "seq_len": 96, "label_len": 0,
                    'pred_len': 0,
                    "train_epochs": 10, "learning_rate": 0.0005},
        'ETTh2': {"root_path": "ETT-small", "data_path": "ETTh2.csv", "data": "ETTh2_mask", "enc_in": 7, "dec_in": 7,
                  "c_out": 7, "batch_size": 16, "d_model": 32, "seq_len": 96, "label_len": 0, 'pred_len': 0,
                  "train_epochs": 30, "learning_rate": 0.0005},
        'ETTm1': {"root_path": "ETT-small", "data_path": "ETTm1.csv", "data": "ETTm1_mask", "enc_in": 7, "dec_in": 7,
                  "c_out": 7, 'batch_size': 16, "d_model": 64, "seq_len": 96, "label_len": 0, 'pred_len': 0,
                  "train_epochs": 30, "learning_rate": 0.0005}
    ...
    for data, info in data_info.items():
        ...
        for mask_rate in mask_rate_list:
            ...
            logger.info("=======mask_rate:{}".format(mask_rate))
            ...
            parser.add_argument('--pred_len', type=int, default=info['pred_len'], help='prediction sequence length')
            parser.add_argument('--seasonal_patterns', type=str, default='Monthly', help='subset for M4')
            parser.add_argument('--inverse', action='store_true', help='inverse output data', default=False)

            # inputation task
            parser.add_argument('--mask_rate', type=float, default=mask_rate, help='mask ratio')
            ...
            parser.add_argument('--batch_size', type=int, default=info['batch_size'],
            ...
            parser.add_argument('--lr', type=float, default=info['learning_rate'],
            ...
            setting = '{}_{}_{}_{}_mr{}_ft{}_sl{}_ll{}_pl{}_dm{}'.format(
                args.task_name,
                args.model,
            ...
            from nets.load_net_imputation import gnn_model
            ...
            from train.train_graph_imputation import train_epoch, evaluate_network
            ...
            try:
                with tqdm(range(params['epochs'])) as t:
                    for epoch in t:
                        ...
                        epoch_test_loss, mse = evaluate_network(args, model, device, test_data, test_loader, epoch, setting)
